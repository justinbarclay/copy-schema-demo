...
** Schemas
I assume you know about Schemas because this is a blog post on how to clone one schema to another. However, if you're new to SQL or have never needed to concern yourself with schemas before Postgres' [[https://www.postgresql.org/docs/current/ddl-schemas.html][docs]] have a great explanation of why you would have different schemas:
